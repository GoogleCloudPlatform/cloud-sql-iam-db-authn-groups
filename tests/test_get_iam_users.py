...
async def test_multiple_groups():
    ...
    """
    iam_users = await get_iam_users(fake_service, groups = ["test-group@test.com", "test-group2@abc.com"])
    assert iam_users == {
        "test-group@test.com" : set(("test@test.com", "user@test.com", "john@abc.com")),
